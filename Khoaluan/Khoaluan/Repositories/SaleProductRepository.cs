...
namespace Khoaluan.Repositories
{
    public class SaleProductRepository:GameStoreRepository<SaleProduct>,ISaleProductRepository
    {
        ...
        {
            var query = @"select Product.Id as ProductId,Product.Name as ProductName, Discount, Status,Image,Price,Sale.Name as NameSale,StartDate,EndDate,Developer.Name as DevName,Description,Overview from Product
